      ...
      <AIProvider type="inkeep" loadEngine={props.open}>
        <DialogPortal>
          ...
          <DialogContent
            ...
            className="fixed bottom-20 left-1/2 z-50 w-[98vw] max-w-[720px] -translate-x-1/2 focus-visible:outline-none data-[state=closed]:animate-fd-dialog-out data-[state=open]:animate-fd-dialog-in"
          >
            <ShowOnMessages>
            ...
            <div className="flex flex-row gap-2 items-center bg-fd-muted text-fd-muted-foreground px-3 py-1.5 rounded-b-xl border-b border-x shadow-lg">
              <DialogTitle className="text-xs flex-1">
                Powered by{" "}
                <a
                  href="https://snayu-ai.github.io/supagent/"
                  target="_blank"
